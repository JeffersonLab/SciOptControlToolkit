...
class MOLCER(Replay):
    def __init__(self, state_dim, action_dim, reward_dim, logdir, buffer_size=None, cfg='er.cfg'):
    ...
    def sample(self, nsamples):
        ...
        return (
            ...
            self.lyapunov_variables[self.indices]
        )
    ...
    def save(self, filename='replay_buffer.npy'):
        data = {
            ...
            "dones": self.dones,
            "alphas": self.alphas,
            "lyapunov_variables": self.lyapunov_variables
        }
    ...
    def load(self, filename):
        ...
        self.lyapunov_variables = data["lyapunov_variables"]
